...
- **[2026]** Serving as Industry Track Chair for [IEEE IC2E 2026](https://conferences.computer.org/IC2E/).
- **[2026]** Patent filed: *Symmetric Heap-Based Work-Stealing Framework for Resilient Distributed Systems* (Jan 2026).
- **[2025]** Paper accepted at SC'25 Workshops: *A Query Engine for Scientific Data Exploration using Theory, Simulation, and Artificial Intelligence Models*.
- **[2025]** Presented [*Global Distributed Client-side Cache for DAOS*](https://cug.org/proceedings/cug2025_proceedings/includes/files/pap115s2-file1.pdf) at CUG 2025.
- **[2025]** US Patent granted: *Client Allocation of Memory Across Memory Servers* (Apr 2025).
- **[2025]** US Patent granted: *Incremental Data Backup Using a Combined Tracking Data Structure* (Oct 2025).
